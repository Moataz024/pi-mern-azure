    ...
    useEffect(() => {
        ...
        /* async function fetchUserData() {
            try {
                const userResponse = await axios.get(`https://link-up-tournament.azurewebsites.net/User/getbyemail?email=${USER.email}`);
                const userId = userResponse.data._id;
                const response = await fetch(`https://link-up-tournament.azurewebsites.net/User/getbyid/${userId}`);
        ...
        const fetchTeamRating = async (teamId) => {
            try {
                const response = await fetch(`https://link-up-tournament.azurewebsites.net/Team/getTeamRating/${teamId}`);
