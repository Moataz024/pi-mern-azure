...
const TournamentAdminDisplay = () => {
    ...
    const fetchReferees = async () => {
        try {
            const response = await fetch('https://link-up-tournament.azurewebsites.net/User/getAllReferees');
            if (!response.ok) {
    ...
    const fetchStadiums = async () => {
        try {
            const response = await fetch('https://link-up-tournament.azurewebsites.net/Stadium/getall');
            if (!response.ok) {
    ...
    const handleDeleteTournament = async (tournamentId) => {
        try {
            const response = await fetch(`https://link-up-tournament.azurewebsites.net/Tournament/delete/${tournamentId}`, {
                method: 'DELETE',
            });
            if (!response.ok) {
    ...
    const handleSetActiveTournament = async (tournamentId, currentStatus) => {
        try {
            ...
            const response = await fetch(`https://link-up-tournament.azurewebsites.net/Tournament/StartTournament/${tournamentId}`, {
                method: 'PUT',
