  ...
  useEffect(() => {
    const fetchMatch = async () => {
      try {
        ...
        const team1Response = await fetch(`https://link-up-tournament.azurewebsites.net/Team/getbyid/${data.team1}`);
        if (!team1Response.ok) {
        ...
        const team2Response = await fetch(`https://link-up-tournament.azurewebsites.net/Team/getbyid/${data.team2}`);
        if (!team2Response.ok) {
          throw new Error('Failed to fetch team details');
        }
