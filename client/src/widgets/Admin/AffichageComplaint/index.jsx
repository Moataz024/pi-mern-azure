...
const AffichageCrud = () => {
    ...
    const handleSearch = () => {
        ...
        if (!searchTerm) {
            const fetchData = async () => {
                try {
                    const response = await axios.get('https://link-up-tournament.azurewebsites.net/api/AllComplaints');
    ...
    const handleDeleteComplaint = async (complaintId) => {
        try {
            ...
            if (confirmed) {
                const apiResponse = await axios.delete(`https://link-up-tournament.azurewebsites.net/api/complaints/${complaintId}`);
    ...
    const handleSubmitResponse = async () => {
        try {
            ...
            const apiResponse = await axios.put('https://link-up-tournament.azurewebsites.net/api/complaints/respond', {
                complaintId: selectedComplaint._id,
                response: responseValue,
            });
