...
*/}
  ...
  useEffect(() => {
    const fetchTournaments = async () => {
      try {
        ...
        const response = await axios.get(`https://link-up-tournament.azurewebsites.net/Tournament/getByUserId/${userId}`);
  ...
  const handleConfirmation = async () => {
    try {
      ...
      const response = await axios.post('https://link-up-tournament.azurewebsites.net/Payment/createPayment', formData);
      ...
      if (addressesMatch && payment) {
        await axios.put(`https://link-up-tournament.azurewebsites.net/Payment/${payment._id}`, { payment_status: 'paid' });
        toast.success("Your payment has been processed successfully!");
