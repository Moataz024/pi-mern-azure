  ...
  const socket = io('https://link-up-tournament.azurewebsites.net', { transports : ['websocket'] });
    ...
    useEffect(() => {
      ...
      const fetchResult = async () => { 
        try {
          const response = await axios.get(`https://link-up-tournament.azurewebsites.net/result/result/${id}`); // Assuming you have an endpoint to get the current result
          setResult(response.data);
          const teamsResponse = await axios.get(`https://link-up-tournament.azurewebsites.net/result/teams/${id}`);
