...
const Chatbot = () => {
    ...
    useEffect(() => {
        async function fetchData() {
          try {
            const response = await axios.get(`https://link-up-tournament.azurewebsites.net/User/getbyemail?email=${USER.email}`);
            ...
            if (userdata.includes(21)) {
              ...
              const responseTeam = await axios.get(`https://link-up-tournament.azurewebsites.net/Team/checkTeam_manager/${UserId}`);
            ...
            const lineupResponse = await fetch(`https://link-up-tournament.azurewebsites.net/Team/getLineup/${userId}`);
