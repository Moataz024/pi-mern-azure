...
export const LineupTeams = ({ id }) => {
  ...
  useEffect(() => {
    const fetchTeamsData = async () => {
      try {
        const response = await axios.get(`https://link-up-tournament.azurewebsites.net/Team/getTeamsByMatch/${id}`);
        const data = response.data;
        const teamID1 = data.team1Lineup.team;
        const teamID2 = data.team2Lineup.team;

        const team1Response = await axios.get(`https://link-up-tournament.azurewebsites.net/Team/getbyid/${teamID1}`);
        ...
        const team2Response = await axios.get(`https://link-up-tournament.azurewebsites.net/Team/getbyid/${teamID2}`);
        ...
        if (data && data.team2Lineup && data.team1Lineup && data.team2Lineup.playerNames && data.team1Lineup.playerNames) {
            ...
            const responseTeam1 = await fetch('https://link-up-tournament.azurewebsites.net/Team/addLineup/', {
                method: 'POST',
                headers: {
            ...
            const responseTeam2 = await fetch('https://link-up-tournament.azurewebsites.net/Team/addLineup/', {
                method: 'POST',
                headers: {
                'Content-Type': 'application/json'
                },
