...
async function add(req, res) {
    ...
    try {
        ...
        team.logo = "https://link-up-tournament.azurewebsites.net/uploads/team/"+req.file.filename ;
        team.players =  [];
    ...
    try {
        ...
        if (team.players && team.players.length > 0) {
            ...
            const playerPromises = team.players.map(async playerId => {
                const playerResponse = await fetch(`https://link-up-tournament.azurewebsites.net/User/getbyid/${playerId}`);
